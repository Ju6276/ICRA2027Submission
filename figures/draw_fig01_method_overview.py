...
def main():
    ...
    label(ax,.36,.35,"2.43-ms forward pass",size=7.0,color=SUBTLE)
    ...
    panel(ax,.567,.205,.063,.10,face=ACTION_GREEN)
    label(ax,.5985,.271,"Command",size=6.4,weight="bold")
    label(ax,.5985,.235,"100 Hz",size=6.8)
