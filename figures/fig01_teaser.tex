...
\begin{tikzpicture}[node distance=4mm and 8mm]
  ...
  % The punchline: what the reactive path predicts, before and after.
  \node[bad,below=7mm of fast] (before)
    {prior fast branch: cached prefix,\\full action generation};
  \node[good,below=2mm of before] (after)
    {ours: counterfactual residual,\\one student pass};
  ...
  \begin{scope}[on background layer]
    ...
    \node[rounded corners=4pt,draw=cInk!25,fill=gray!2,inner sep=3mm,
          fit=(slow)(fast)(sum)(cmd),label={[font=\sffamily\tiny\bfseries,text=cInk]above:ONLY THE RESIDUAL IS UPDATED REACTIVELY}] {};
  \end{scope}
\end{tikzpicture}
\end{document}
