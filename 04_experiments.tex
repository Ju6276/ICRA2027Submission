...
Compared with the original ForceVLA baseline, the complete ForceDelta-VLA system improves mean success from $54.4\%$ to $82.2\%$ (Table~\ref{tab:main_results}). It also exceeds TA-VLA, $\pi_{0.5}$, and ImplicitRDP. The improvement over ForceVLA spans all nine tasks and is largest on USB Insertion, Button Pressing, and Plug Insertion.
