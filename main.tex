...
\begin{document}
    ...
    \renewcommand{\@maketitle}{\@oldmaketitle
      ...
      % \vspace{-0.2in}
      \captionof{figure}{ForceDelta-VLA overview. Paired teacher predictions define the force target; reference-action mismatch and reference-state alignment define the delay target. The reference-action pathway updates at approximately $6$~Hz, while the lightweight policy predicts corrections independently. Composed robot commands are sent at $100$~Hz. The ForceVLA comparison runs at approximately $6$~Hz in this setup.}
      \label{fig:teaser}
      \vspace{-0.1in}
      \bigskip}
\makeatother
