...
\begin{document}
    ...
    \renewcommand{\@maketitle}{\@oldmaketitle
      ...
      % \vspace{-0.2in}
      \captionof{figure}{ForceDelta-VLA overview. Force and delay correction targets constructed from a frozen teacher supervise a lightweight student through correction distillation. During execution, the slow teacher supplies reference actions and cached task context. The student uses these together with recent force history and proprioception to predict the two corrections and adjust the reference poses.}
      \label{fig:teaser}
      \vspace{-0.1in}
      \bigskip}
\makeatother
