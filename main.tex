...
\begin{document}
    ...
    \renewcommand{\@maketitle}{\@oldmaketitle
      ...
      % \vspace{-0.2in}
      \captionof{figure}{ForceDelta-VLA overview. Paired teacher predictions define the force target; reference-action mismatch and state rebasing define the delay target. The lightweight policy updates corrections at $100$~Hz between reference-action updates at approximately $6$~Hz. The ForceVLA comparison runs at approximately $6$~Hz in this setup.}
      \label{fig:teaser}
      \vspace{-0.1in}
      \bigskip}
\makeatother
