...
\begin{document}
    ...
    \renewcommand{\@maketitle}{\@oldmaketitle
      ...
      % \vspace{-0.2in}
      \captionof{figure}{ForceDelta-VLA overview. Force and delay targets constructed from a frozen teacher supervise the student through correction distillation. The student predicts pose corrections from reference actions and cached task context provided by the slow teacher, together with recent force history and proprioception. Right: a Button Pressing example comparing ForceVLA and ForceDelta-VLA.}
      \label{fig:teaser}
      \vspace{-0.1in}
      \bigskip}
\makeatother
